...
public class MemoryProductRepositoryTest {
    ...
    public void given_ValidProductDetails_When_AddProduct_Then_ProductIsAdded() {
        int productId = repository.addProduct("Test Product", 100.0, "Category1", 4.5);
    ...
    public void given_MultipleProducts_When_GetAllProducts_Then_AllProductsAreReturned() {
        repository.addProduct("Product1", 50.0, "Category1", 3.5);
        repository.addProduct("Product2", 150.0, "Category2", 4.0);
    ...
    public void given_ExistingProductId_When_RemoveProduct_Then_ProductIsRemoved() {
        int productId = repository.addProduct("Product1", 50.0, "Category1", 3.5);
    ...
    public void given_ListOfProductIds_When_GetProducts_Then_ReturnProducts() {
        int productId1 = repository.addProduct("Product1", 50.0, "Category1", 3.5);
        int productId2 = repository.addProduct("Product2", 150.0, "Category2", 4.0);
