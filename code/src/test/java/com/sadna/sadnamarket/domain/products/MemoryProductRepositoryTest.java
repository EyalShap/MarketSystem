...
public class MemoryProductRepositoryTest {
    ...
    public void given_ValidProductDetails_When_AddProduct_Then_ProductIsAdded() {
        int productId = repository.addProduct("Test Product", 100.0, "Category1", 4.5, 2);
    ...
    public void given_MultipleProducts_When_GetAllProducts_Then_AllProductsAreReturned() {
        repository.addProduct("Product1", 50.0, "Category1", 3.5, 6);
        repository.addProduct("Product2", 150.0, "Category2", 4.0, 3.7);
    ...
    public void given_ExistingProductId_When_RemoveProduct_Then_ProductIsRemoved() {
        int productId = repository.addProduct("Product1", 50.0, "Category1", 3.5, 1);
    ...
    public void given_ExistingProductName_When_FilterByName_Then_ReturnProductsWithThatName() {
        repository.addProduct("Product1", 50.0, "Category1", 3.5, 1);
        repository.addProduct("Product2", 150.0, "Category2", 4.0, 12);
    ...
    public void given_ExistingCategory_When_FilterByCategory_Then_ReturnProductsWithThatCategory() {
        repository.addProduct("Product1", 50.0, "Category1", 3.5, 2);
        repository.addProduct("Product2", 150.0, "Category2", 4.0, 3);
    ...
    public void given_ListOfProductIds_When_GetProducts_Then_ReturnProducts() {
        int productId1 = repository.addProduct("Product1", 50.0, "Category1", 3.5, 4);
        int productId2 = repository.addProduct("Product2", 150.0, "Category2", 4.0, 1.2);
    ...
    public void given_ProductsAdded_When_GetAllProductIds_Then_ReturnAllProductIds() {
        int productId1 = repository.addProduct("Product1", 50.0, "Category1", 3.5, 3);
        int productId2 = repository.addProduct("Product2", 150.0, "Category2", 4.0, 1);
    ...
    public void given_ExistingProductId_When_IsExistProduct_Then_ReturnTrue() {
        int productId = repository.addProduct("Product1", 50.0, "Category1", 3.5, 4);
