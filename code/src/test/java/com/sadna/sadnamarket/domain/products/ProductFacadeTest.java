...
public class ProductFacadeTest {
    ...
    public void given_ValidProductDetailsAndStoreId_When_AddProduct_Then_ProductIsAdded() {
        when(productRepositoryMock.addProduct(anyString(), anyDouble(), anyString(), anyDouble())).thenReturn(1);
        when(productRepositoryMock.getProduct(1)).thenReturn(new Product(1, "Test Product", 100.0, "Category1", 4.5));

        int productId = productFacade.addProduct(1, "Test Product", 100.0, "Category1", 4.5);
        assertEquals(1, productId);
        verify(productRepositoryMock, times(1)).addProduct("Test Product", 100.0, "Category1", 4.5);
    }

    @Test
    public void given_InvalidStoreId_When_AddProduct_Then_ThrowException() {
        assertThrows(IllegalArgumentException.class,
                () -> productFacade.addProduct(-1, "Test Product", 100.0, "Category1", 4.5));
    }
    ...
    public void given_ValidStoreIdAndProductId_When_RemoveProduct_Then_ProductIsRemoved() {
        ...
        Product product = new Product(1, "Test Product", 100.0, "Category1", 4.5);
    ...
    public void given_ValidStoreProductIdsAndFilters_When_GetFilteredProducts_Then_ReturnFilteredProducts() {
        Product product1 = new Product(1, "Product1", 50.0, "Category1", 3.5);
        Product product2 = new Product(2, "Product2", 100.0, "Category2", 4.5);
    ...
    public void given_ValidProductId_When_GetProductDTO_Then_ReturnProductDTO() {
        Product product = new Product(1, "Product1", 50.0, "Category1", 3.5);
        when(productRepositoryMock.getProduct(1)).thenReturn(product);
